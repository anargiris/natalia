    ...
    <div className="min-h-screen bg-zinc-100 relative">
        ...
        <div className="absolute bottom-0 left-0 p-4 xl:p-8 w-full">
          <div className="container mx-auto py-8 flex flex-col xl:flex-row gap-5 xl:gap-0 items-center">
            <div className=" text-zinc-800 text-left">
              <h1 className="text-4xl xl:text-7xl font-bold mb-6">
                Ναταλία Παπουλάκη
              </h1>
              <p className="text-2xl xl:text-5xl font-medium xl:mb-2">
                Κλινική Ψυχολόγος
              </p>
            </div>
          </div>
      ...
      <main className="container px-4 pb-4 mx-auto mt-6 xl:mt-12  leading-9 relative ">
        ...
        >
          ...
          <TabsContent value="Βιογραφικό" className="mt-8 px-1.5 xl:px-0">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.6 }}
            >
              <p className="text-zinc-700 text-xl xl:text-2xl !leading-relaxed">
                Η Ναταλία Παπουλάκη είναι <b>Κλινική Ψυχολόγος</b>. Αποφοίτησε
                από το <b>Τμήμα Ψυχολογίας</b> του{" "}
                <b>Αριστοτελείου Πανεπιστημίου</b> Θεσσαλονίκης και ολοκλήρωσε
                μεταπτυχιακές σπουδές στη Κλινική Ψυχολογία στο ίδιο Τμήμα. Έχει
                πραγματοποιήσει κλινική άσκηση στη{" "}
                <b>
                  Β’ Πανεπιστημιακή Κλινική του Ψυχιατρικού Νοσοκομείου
                  Θεσσαλονίκης
                </b>{" "}
                και στο{" "}
                <b>
                  Εργαστήριο Εφαρμοσμένης Ψυχολογίας (Ε.ΕΦΑ.Ψ) του Αριστοτελείου
                  Πανεπιστήμιου
                </b>
                . Στο πλαίσιο συνεχούς κατάρτισης και εξειδίκευσης, παρακολουθεί
                το πρόγραμμα μετεκπαίδευσης και ομάδων εποπτείας του Ινστιτούτου
                Ψυχολογίας και Υγείας, εστιάζοντας στην ψυχοδυναμική πρακτική.{" "}
                <br />
                <br />
                ...
                , προσφέροντας συμβουλευτικές υπηρεσίες σε φοιτητές/τριες.
                Υπήρξε{" "}
                <b>
                  Επιστημονική Συνεργάτιδα του Εργαστηρίου Εφαρμοσμένης
                  Ψυχολογίας του Αριστοτελείου Πανεπιστημίου
                </b>
                , παρέχοντας ψυχοθεραπευτικές συνεδρίες.
              </p>
            </motion.div>
          </TabsContent>
          <TabsContent value="Υπηρεσίες" className="mt-8 px-1 xl:px-0">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.6 }}
            >
              <div className="flex flex-col gap-4 mb-8">
                <h3 className="text-2xl xl:text-4xl font-bold text-gray-800">
                  Ψυχοθεραπεία Ενηλίκων
                </h3>
                <p className="text-zinc-700 text-base xl:text-2xl ">
              ...
              <div className="flex flex-col gap-4">
                <h3 className="text-2xl xl:text-4xl font-bold text-gray-800 mb-2">
                  Δια ζώσης ή διαδικτυακές συνεδρίες
                </h3>
              </div>
            </motion.div>
          </TabsContent>
          <TabsContent value="Επικοινωνία" className="mt-8 px-4 xl:px-0">
            <div className="flex items-center gap-4 mb-8">
              ...
              <a
                className="text-xl xl:text-2xl font-medium"
                href="tel:6980417839"
              >
                6980417839
              </a>
