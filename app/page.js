...
export default function PsychologistLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50">
      {/* Header */}
      <header className="relative h-[30vh] md:h-[40vh] overflow-hidden">
        <Image
          src="/bg-photo.jpg"
          alt="Background"
          fill
        ...
        <div className="absolute bottom-0 left-0 p-4 md:p-8 w-full">
          <div className="container mx-auto py-8 flex flex-col md:flex-row gap-5 md:gap-0 items-center">
            <div className=" text-zinc-800 text-left">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Ναταλία Παπουλάκη
              </h1>
              <p className="text-2xl md:text-3xl font-medium md:mb-2 font-garamond">
                Κλινική Ψυχολόγος
              </p>
            </div>
          </div>
      ...
      {/* Main Content */}
      <main className="container px-4 md:px-0 mx-auto mt-6 md:mt-12 bg-zinc-50  leading-9">
        <Tabs
        ...
        >
          <TabsList className="grid w-full grid-cols-3 items-center">
            {["Βιογραφικό", "Υπηρεσίες", "Επικοινωνία"].map((tab) => (
              <TabsTrigger
                key={tab}
                value={tab}
                className={`relative transition-all duration-150 ease-in-out py-2.5 hover:bg-blue-100  text-lg font-medium `}
              >
                {activeTab === tab && (
                  <motion.span
                    layoutId="bubble"
          ...
          <TabsContent value="Βιογραφικό" className="mt-8 px-1.5 md:px-0">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          <TabsContent value="Υπηρεσίες" className="mt-8 px-1 md:px-0">
            {" "}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          <TabsContent value="Επικοινωνία" className="mt-8 px-4 md:px-0">
            <div className="flex items-center gap-4 mb-8">
              ...
              <a className="text-lg font-medium" href="tel:6980417839">
                6980417839
              </a>
            </div>
